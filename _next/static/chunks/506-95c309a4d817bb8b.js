        ...
        4910: function(e, t, n) {
            ...
            let S = (0, f.forwardRef)((e, t) => {
                let {
                    children: n,
                    ...r
                } = e, o = f.Children.toArray(n), a = o.find(P);
                if (a) {
                    ...
                    return (0, f.createElement)(O, i({}, r, {
                        ref: t
            ...
            let O = (0, f.forwardRef)((e, t) => {
                ...
                return (0, f.isValidElement)(n) ? (0, f.cloneElement)(n, { ... function(e, t) {
                        let n = { ...t
                        };
                        for (let r in t) {
                            let o = e[r],
            ...
            let R = ["a", "button", "div", "form", "h2", "h3", "img", "input", "label", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((e, t) => {
                ...
                D = (0, f.forwardRef)((e, t) => {
                    ...
                    let {
                        ...
                        onDismiss: s,
                        ...d
                    } = e, p = (0, f.useContext)(T), [v, g] = (0, f.useState)(null), E = null !== (n = null == v ? void 0 : v.ownerDocument) && void 0 !== n ? n : null == globalThis ? void 0 : globalThis.document, [, y] = (0, f.useState)({}), b = h(t, e => g(e)), C = Array.from(p.layers), [S] = [...p.layersWithOutsidePointerEventsDisabled].slice(-1), O = C.indexOf(S), _ = v ? C.indexOf(v) : -1, P = p.layersWithOutsidePointerEventsDisabled.size > 0, D = _ >= O, M = function(e, t = null == globalThis ? void 0 : globalThis.document) {
                        let n = w(e),
                            r = (0, f.useRef)(!1),
                            o = (0, f.useRef)(() => {});
                        return (0, f.useEffect)(() => {
            ...
            let M = "focusScope.autoFocusOnMount",
                ...
                I = (0, f.forwardRef)((e, t) => {
                    let {
                        ...
                        ...l
                    } = e, [u, c] = (0, f.useState)(null), s = w(o), d = w(a), p = (0, f.useRef)(null), m = h(t, e => c(e)), v = (0, f.useRef)({
                        paused: !1,
                        pause() {
                            this.paused = !0
                        },
                    ...
                    (0, f.useEffect)(() => {
                        ...
                        if (u) {
                            ...
                            if (!t) {
                                ...
                                u.addEventListener(M, s), u.dispatchEvent(t), t.defaultPrevented || (function(e, {
                                    select: t = !1
                                } = {}) {
                            ...
                            return () => {
                                u.removeEventListener(M, s), setTimeout(() => {
                                    ...
                                    u.addEventListener(L, d), u.dispatchEvent(t), t.defaultPrevented || W(null != e ? e : document.body, {
                                        select: !0
                                    }), u.removeEventListener(L, d), z.remove(v)
                                }, 0)
                            }
                        }
                    }, [u, s, d, v]);
                    ...
                    return (0, f.createElement)(R.div, i({
                        tabIndex: -1
                    }, l, {
                        ref: m,
                        onKeyDown: g
            ...
            let U = (0, f.forwardRef)((e, t) => {
                    ...
                    return r ? C.createPortal((0, f.createElement)(R.div, i({}, o, {
                        ref: t
                    })), r) : null
                }),
                K = e => {
                    let {
                        ...
                        var t;
                        let [n, r] = (0, f.useState)(), o = (0, f.useRef)({}), i = (0, f.useRef)(e), a = (0, f.useRef)("none"), [l, u] = (t = {
                            mounted: {
                                UNMOUNT: "unmounted",
                        ...
                        present: r.isPresent
                    }) : f.Children.only(n), i = h(r.ref, o.ref);
                    return "function" == typeof n || r.isPresent ? (0, f.cloneElement)(o, {
                        ref: i
                    }) : null
                };
                ...
                eO = (G.useMedium(function(e) {
                    ...
                    f.useEffect(function() {
                        return eS.push(i), e.setCallbacks({
                            ...
                            }), document.addEventListener("wheel", u, ep), document.addEventListener("touchmove", u, ep), document.addEventListener("touchstart", s, ep),
                            function() {
            ...
            let eM = "Dialog",
                    ...
                    return r.scopeName = e, [function(t, r) {
                        ...
                        function a(t) {
                            let {
                                ...
                                children: r,
                                ...a
                            } = t, l = (null == n ? void 0 : n[e][i]) || o, u = (0, f.useMemo)(() => a, Object.values(a));
                            return (0, f.createElement)(l.Provider, {
                                value: u
                            }, r)
                        }
                ...
                ej = e => {
                    let {
                        ...
                        onOpenChange: i,
                        modal: a = !0
                    } = e, l = (0, f.useRef)(null), u = (0, f.useRef)(null), [c = !1, s] = function({
                        prop: e,
                        defaultProp: t,
                        onChange: n = () => {}
                    }) {
                        let [r, o] = function({
                            ...
                            defaultProp: t,
                            onChange: n
                        }), i = void 0 !== e, a = w(n), l = (0, f.useCallback)(t => {
                            if (i) {
                ...
                eW = (0, f.forwardRef)((e, t) => {
                    let {
                        __scopeDialog: n,
                        ...r
                    } = e, o = eF("DialogTrigger", n), a = h(t, o.triggerRef);
                ...
                eK = e => {
                    ...
                    return (0, f.createElement)(eB, {
                        scope: t,
                        forceMount: n
                    }, f.Children.map(r, e => (0, f.createElement)(K, {
                        present: n || i.open
                    }, (0, f.createElement)(U, {
                        asChild: !0,
                        container: o
                ...
                e$ = (0, f.forwardRef)((e, t) => {
                    ...
                    return a.modal ? (0, f.createElement)(K, {
                        present: r || a.open
                    }, (0, f.createElement)(eV, i({}, o, {
                        ref: t
                    }))) : null
                }),
                ...
                eX = (0, f.forwardRef)((e, t) => {
                    ...
                    return (0, f.createElement)(K, {
                        present: r || a.open
                    }, a.modal ? (0, f.createElement)(eZ, i({}, o, {
                        ref: t
                    })) : (0, f.createElement)(eH, i({}, o, {
                        ref: t
                    })))
                }),
                ...
                eG = (0, f.forwardRef)((e, t) => {
                    let {
                        ...
                        onCloseAutoFocus: a,
                        ...l
                    } = e, u = eF(eq, n), c = (0, f.useRef)(null), s = h(t, c);
                    return (0, f.useEffect)(() => {
                        var e, t;
                ...
                eQ = (0, f.forwardRef)((e, t) => {
                    ...
                    return (0, f.createElement)(R.h2, i({
                        id: o.titleId
                    }, r, {
                        ref: t
                    }))
            ...
            let [e3, e2] = function(e, t) {
                ...
                function r(e) {
                    let {
                        children: t,
                        ...r
                    } = e, o = (0, f.useMemo)(() => r, Object.values(r));
                    return (0, f.createElement)(n.Provider, {
                        value: o
                    }, t)
                }
                ...
                titleName: eJ,
                docsSlug: "dialog"
            }), e7 = ej, e4 = eW, e5 = eK, e8 = e$, e6 = eX, e9 = eQ, te = e0
        },
        3740: function(e, t, n) {
            "use strict";
            ...
            let E = (0, l.forwardRef)((e, t) => {
                    var {
                        ...
                        onLoad: R,
                        onError: N
                    } = e, T = a._(e, ["imgAttributes", "heightInt", "widthInt", "qualityInt", "className", "imgStyle", "blurStyle", "isLazy", "fetchPriority", "fill", "placeholder", "loading", "srcString", "config", "unoptimized", "loader", "onLoadRef", "onLoadingCompleteRef", "setBlurComplete", "setShowAltText", "onLoad", "onError"]);
